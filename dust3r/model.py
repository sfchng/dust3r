...
from models.croco_attnhead24 import CroCoNet_Attnhead24
...
class AsymmetricCroCo3DStereo_Attnhead24 (
    CroCoNet_Attnhead24,
    huggingface_hub.PyTorchModelHubMixin,
    library_name="dust3r",
    repo_url="https://github.com/naver/dust3r",
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kw):
        if os.path.isfile(pretrained_model_name_or_path):
            ...
            try:
                model = super(AsymmetricCroCo3DStereo_Attnhead24, cls).from_pretrained(pretrained_model_name_or_path, **kw)
            except TypeError as e:
                raise Exception(f'tried to load {pretrained_model_name_or_path} from huggingface, but failed')
            return model
